...
public class MileageCalculatorNoConversion extends Application {
	...
	// Task 1: Replace the two Radio Buttons with a single ComboBox
    ObservableList<String> items = FXCollections.observableArrayList(defaultResult, altResult);
    ComboBox<String> cbMTK = new ComboBox<>(items); // Select MPG or KPL
    ...
    public void start(Stage primaryStage) {   	   
        ...
        cbMTK.setOnAction(e -> changeLabels()); 
